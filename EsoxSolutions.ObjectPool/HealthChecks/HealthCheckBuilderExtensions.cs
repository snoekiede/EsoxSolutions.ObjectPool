...
public static class HealthCheckBuilderExtensions
{
    ...
    /// </code>
    /// </example>
    public static IHealthChecksBuilder AddObjectPoolHealthCheck<T>(
        ...
        Action<ObjectPoolHealthCheckOptions>? configureOptions = null) where T : class
    {
        ...
        var effectiveTags = tags ?? new[] { "ready", "objectpool" };
    ...
    /// </code>
    /// </example>
    public static IHealthChecksBuilder AddAllObjectPoolHealthChecks(
        this IHealthChecksBuilder builder,
        HealthStatus? failureStatus = null,
        IEnumerable<string>? tags = null)
    {
    ...
    /// <param name="configureOptions">Optional action to configure health check options</param>
    /// <returns>The health checks builder for chaining</returns>
    public static IHealthChecksBuilder AddQueryablePoolHealthCheck<T>(
        this IHealthChecksBuilder builder,
        string? name = null,
        HealthStatus? failureStatus = null,
        IEnumerable<string>? tags = null,
